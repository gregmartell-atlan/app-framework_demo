...
**Repo:** https://github.com/gregmartell-atlan/app-framework_demo  
**Branch:** `claude/review-and-setup-testing-GzGvk` (or pick up from PR #1)
...
3. Set the glossary name in the workflow (line 12 of `push-glossary.yaml`):
   ```yaml
   glossary_name:
     default: "sony_telemetry"   # ← change from ghost_tsushima to your glossary name
   ```
...
git clone https://github.com/gregmartell-atlan/app-framework_demo
```
